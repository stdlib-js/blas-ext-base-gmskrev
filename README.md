...
```javascript
import gmskrev from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gmskrev@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gmskrev@deno/mod.js';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-gmskrev.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-gmskrev

[test-image]: https://github.com/stdlib-js/blas-ext-base-gmskrev/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-gmskrev/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-gmskrev/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-gmskrev?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-gmskrev.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-gmskrev/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-gmskrev/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-gmskrev/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-gmskrev/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-gmskrev/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-gmskrev/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-gmskrev/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-gmskrev/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-gmskrev/main/LICENSE

[mdn-typed-array]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray

[@stdlib/array/complex64]: https://github.com/stdlib-js/array-complex64/tree/deno

[@stdlib/blas/ext/base/dmskrev]: https://github.com/stdlib-js/blas-ext-base-dmskrev/tree/deno

[@stdlib/blas/ext/base/smskrev]: https://github.com/stdlib-js/blas-ext-base-smskrev/tree/deno
